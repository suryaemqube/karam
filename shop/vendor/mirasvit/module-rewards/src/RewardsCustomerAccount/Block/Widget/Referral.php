...
class Referral extends Template implements BlockInterface
{
     ...
     * @return bool
     */
    public function getAddToAnyScript()
    {
        return $this->widget->getAddToAnyWidgetCode();
    }
    ...
    public function getCustomerId()
    {
        ...
        return $objectManager->create(\Magento\Customer\Model\Session::class)->getCustomer()->getData('entity_id');
    }
}
