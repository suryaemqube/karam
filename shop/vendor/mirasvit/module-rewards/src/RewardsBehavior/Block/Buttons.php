...
class Buttons extends \Mirasvit\RewardsBehavior\Block\Buttons\AbstractButtons
{
     ...
     * @return bool
     */
    public function isAddToAnyActive()
    {
        return $this->rewardsConfig->getAddToAnyIsActive();
    }

    /**
     * @return string
     */
    public function getAddToAnyCode()
    {
        return $this->rewardsConfig->getAddToAnyCode();
    }
    ...
    public function isActive()
    {
        return $this->isLikeActive() || $this->isTweetActive() || $this->isReferralActive()
            || $this->isPinActive() || $this->isAddToAnyActive();
    }
