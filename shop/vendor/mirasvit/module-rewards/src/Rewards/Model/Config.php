...
class Config
{
     ...
     * @return string
     */
    public function getAddToAnyWidgetCode($store = null)
    {
        return $this->scopeConfig->getValue(
            'rewards/mst_rewards_widget/addtoany_code',
            ScopeInterface::SCOPE_WEBSITE,
            $store
        );
    }
    ...
    public function getAdvancedSettingsCustomRuleList($store = null)
    {
        ...
        foreach (explode(PHP_EOL, $list) as $rule) {
            ...
            [$code, $name] = explode(',', (string)$rule, 2);
            $rules[] = [
                'code' => $code,
     ...
     * @return int
     */
    public function getExpirationPointsDays($store = null): int
    {
        return (int)$this->scopeConfig->getValue(
            'rewards/display_options/last_expiring_days',
            ScopeInterface::SCOPE_STORE,
            $store
        );
    }
     ...
     * @SuppressWarnings(PHPMD.BooleanGetMethodName)
     */
    public function getAddToAnyIsActive($store = null)
    {
        return $this->scopeConfig->getValue(
            'rewardssocial/addtoany/is_active',
            ScopeInterface::SCOPE_STORE,
            $store
        );
    }
     ...
     * @SuppressWarnings(PHPMD.BooleanGetMethodName)
     */
    public function getAddToAnyCode($store = null)
    {
        return $this->scopeConfig->getValue(
            'rewardssocial/addtoany/code',
            ScopeInterface::SCOPE_STORE,
            $store
        );
    }
