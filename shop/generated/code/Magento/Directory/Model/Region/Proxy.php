...
/**
 * Proxy class for @see \Magento\Directory\Model\Region
 */
class Proxy extends \Magento\Directory\Model\Region implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Directory\\Model\\Region', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->loadByCode($code, $countryId);
    }
    ...
    {
        return $this->_getSubject()->loadByName($name, $countryId);
    }
