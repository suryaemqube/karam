...
/**
 * Proxy class for @see \Wyomind\PointOfSale\Model\ResourceModel\PointOfSale\Collection
 */
class Proxy extends \Wyomind\PointOfSale\Model\ResourceModel\PointOfSale\Collection implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Wyomind\\PointOfSale\\Model\\ResourceModel\\PointOfSale\\Collection', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->getPlace($id);
    }
    ...
    {
        return $this->_getSubject()->addCustomAttributes();
    }
    ...
    {
        return $this->_getSubject()->getPlacesByStoreId($storeId, $whereGroupId);
    }
    ...
    {
        return $this->_getSubject()->getCountries($storeId);
    }
    ...
    {
        return $this->_getSubject()->getLastInsertedId();
    }
     ...
     * {@inheritdoc}
     */
    public function getByUrlKeyAndCurrentStore($urlKey)
    {
        return $this->_getSubject()->getByUrlKeyAndCurrentStore($urlKey);
    }
