<?php
namespace Mirasvit\Rewards\Model\ResourceModel\Transaction\Collection;

/**
 * Interceptor class for @see \Mirasvit\Rewards\Model\ResourceModel\Transaction\Collection
 */
class Interceptor extends \Mirasvit\Rewards\Model\ResourceModel\Transaction\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Stdlib\DateTime\DateTime $date, \Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Store\Model\StoreManagerInterface $storeManager, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addActivatedFilter');
        return $pluginInfo ? $this->___callPlugins('addActivatedFilter', func_get_args(), $pluginInfo) : parent::addActivatedFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addInActivatedFilter');
        return $pluginInfo ? $this->___callPlugins('addInActivatedFilter', func_get_args(), $pluginInfo) : parent::addInActivatedFilter();
    }
    ...
    public function joinCustomerName()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('joinCustomerName', func_get_args(), $pluginInfo) : parent::joinCustomerName();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinCustomerGroup');
        return $pluginInfo ? $this->___callPlugins('joinCustomerGroup', func_get_args(), $pluginInfo) : parent::joinCustomerGroup();
    }
