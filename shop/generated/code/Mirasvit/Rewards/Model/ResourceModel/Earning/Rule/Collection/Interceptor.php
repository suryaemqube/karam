<?php
namespace Mirasvit\Rewards\Model\ResourceModel\Earning\Rule\Collection;

/**
 * Interceptor class for @see \Mirasvit\Rewards\Model\ResourceModel\Earning\Rule\Collection
 */
class Interceptor extends \Mirasvit\Rewards\Model\ResourceModel\Earning\Rule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($date, $entityFactory, $logger, $fetchStrategy, $eventManager, $storeManager, $connection, $resource);
    }
    ...
    public function toOptionArray($emptyOption = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('toOptionArray', func_get_args(), $pluginInfo) : parent::toOptionArray($emptyOption);
    }
    ...
    public function getOptionArray($emptyOption = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getOptionArray', func_get_args(), $pluginInfo) : parent::getOptionArray($emptyOption);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addWebsiteColumn');
        return $pluginInfo ? $this->___callPlugins('addWebsiteColumn', func_get_args(), $pluginInfo) : parent::addWebsiteColumn();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerGroupColumn');
        return $pluginInfo ? $this->___callPlugins('addCustomerGroupColumn', func_get_args(), $pluginInfo) : parent::addCustomerGroupColumn();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCurrentFilter');
        return $pluginInfo ? $this->___callPlugins('addCurrentFilter', func_get_args(), $pluginInfo) : parent::addCurrentFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addShowOnProductPageFilter');
        return $pluginInfo ? $this->___callPlugins('addShowOnProductPageFilter', func_get_args(), $pluginInfo) : parent::addShowOnProductPageFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductPageFilter');
        return $pluginInfo ? $this->___callPlugins('addProductPageFilter', func_get_args(), $pluginInfo) : parent::addProductPageFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addEarnPointsColumn');
        return $pluginInfo ? $this->___callPlugins('addEarnPointsColumn', func_get_args(), $pluginInfo) : parent::addEarnPointsColumn();
    }
