<?php
namespace Sparsh\SalesEmailAttachments\Mail\Template\TransportBuilder;

/**
 * Interceptor class for @see \Sparsh\SalesEmailAttachments\Mail\Template\TransportBuilder
 */
class Interceptor extends \Sparsh\SalesEmailAttachments\Mail\Template\TransportBuilder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addAttachment($content, $fileName, $fileType)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addAttachment', func_get_args(), $pluginInfo) : parent::addAttachment($content, $fileName, $fileType);
    }
}
