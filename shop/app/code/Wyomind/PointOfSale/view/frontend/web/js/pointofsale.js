...
define(["jquery"], function ($) {
    ...
    return {
        ...
        displaySearch: function (error) {
            ...
            var myPlace = "<div>";
            myPlace += msg;
            myPlace += "<input id='geocoder' value='" + value + "' onfocus='this.value=\"\";' onkeydown='if (event.key == \"Enter\") { require([\"jquery\", \"pointofsale\"], function($, pointofsale) {pointofsale.findPlace($(\"#geocoder\").attr(\"value\"), null);}); return false;};' />";
            myPlace += "<button type='button' onclick='require([\"jquery\", \"pointofsale\"], function($, pointofsale) {pointofsale.findPlace($(\"#geocoder\").attr(\"value\"), null);});' value='" + this.W_GP.strings.findMe + "'>" + this.W_GP.strings.findMe + "</button>";
            $("#tools").html(myPlace);
        },
        ...
        updateInfoWindowContent: function () {
            let pStore = this.getCookie("preferred_store");
            if (pStore != null && pStore != "") {
                var preferredStore = $.parseJSON(pStore);
        ...
        blindStore: function (index) {
            var id = this.getStoreIdByIndex(index).replace('/','\\/');
