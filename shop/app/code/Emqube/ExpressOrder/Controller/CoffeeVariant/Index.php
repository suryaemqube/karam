...
namespace Emqube\ExpressOrder\Controller\CoffeeVariant;
    ...
    public function execute()
    {
        if ($this->getRequest()->getPost('product_id')){
           ...
           foreach ($_children as $child){
              ...
              array_push($attributes_coffee_no,['id' =>$child->getData('coffee_type'), 'value'=>$child->getData('coffee_no'),'label'=>$child->getAttributeText('coffee_no')." - ".$child->getAttributeText('coffee_type')]);
           }
