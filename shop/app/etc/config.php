...
return [
    'modules' => [
        ...
        'Customerdata_Import' => 0,
        'Custommodule_Instaconnect' => 1,
        'Dangs_TaxInfoHide' => 1,
        'Emqube_CartRestore' => 1,
        'Emqube_CategoryAttribute' => 1,
        'Emqube_CategoryLanding' => 1,
        'Emqube_ExpressOrder' => 1,
        'Emqube_FiltersModule' => 1,
        'Emqube_Invoice' => 1,
        'Emqube_PriceRange' => 1,
        'Emqube_ProductPage' => 1,
        'Emqube_RestoreCart' => 1,
        'Emqube_ShippingMethods' => 1,
        'Emqube_Singlesign' => 0,
        'Wyomind_Framework' => 1,
        'Karamcoffee_Cbd' => 1,
        'Karamcoffee_Maraexpress' => 1,
        ...
        'Mageplaza_Smtp' => 1,
        'Magezon_Core' => 1,
        'Magezon_AdvancedContact' => 1,
        'Meetanshi_SubscriptionRestriction' => 1,
        'Mirasvit_Core' => 1,
        'Mirasvit_Report' => 1,
        'Mirasvit_Rewards' => 1,
        ...
        'Placeholder_Telephone' => 1,
        'Postpay_Payment' => 1,
        'Solwin_Core' => 1,
        'Solwin_Instagram' => 1,
        'Sparsh_SalesEmailAttachments' => 1,
        'StripeIntegration_Payments' => 1,
        'Temando_ShippingRemover' => 1,
        'Veriteworks_CookieFix' => 1,
        'What3Words_What3Words' => 1,
        'WpTablesExclude_TablesExclude' => 1,
        'Wyomind_PointOfSale' => 1,
        'Wyomind_PickupAtStore' => 0,
        'Emqube_WyomindFixed' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
